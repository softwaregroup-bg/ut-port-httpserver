...
module.exports = {
    ...
    ports: [8003, 8004],
    imports:[],
    identityNamespace: 'identity', // default value: identity, if empty string is set, no identity check will be applied. this is useful when other namespace than identity will be used for identity check
